 ...
 * Version:
 * Description: Add Report Details Screen
 * Date:
 */
...
import {sendReportData} from '../../Redux/Actions/AddReportDetails.actions';
...
class AddReportDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [
        ...
        <ScrollView>
          ...
          <TouchableOpacity
            ...
            {this.state.avatarSource ? (
              ...
              <Image source={Images.REPORT_IMAGE_UPLOAD} style={styles.icon} />
            )}
            {/* <Image source={Images.REPORT_IMAGE_UPLOAD} style={styles.icon} /> */}
            {/* <Image
              source={this.state.avatarSource}
...
const mapDispatchToProps = (dispatch) => {
  return {
    sendReportData: () => dispatch(sendReportData()),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(AddReportDetails);
